...
import unittest
import requests
from API_D.Common.public.ddt_config import ddt, data, unpack
...
class TestCases(unittest.TestCase):
    ...
    @data(*t)
    @unpack
    def test_cases(self,CaseId,
                   Module, URL, Title, Method, Params,
                   Sql, ExpectedResult, ActualResult, TestResult):
        '''这是一个用来测试注册登录的模块'''
        ...
        logger.info(f'正在执行{Module}模块{CaseId}条用例，测试数据是{Params}')
